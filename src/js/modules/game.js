...
// import { MobileControls } from '../utils/mobile-controls.js';
...
export class Game {
  ...
  startGame() {
    ...
    this.food.setNewFoodPosition(this.snake.snake);
  ...
  gameProcess() {
    ...
    this.showGrid();
    this.food.showFood();
    const result = this.snake.showSnake(this.food.foodPosition);
    if (result) {
      if (result.collision) {
        this.endGame();
  ...
  removeMobileControls() {
    if (this.mobileControls) this.mobileControls.removeControls();
  }
